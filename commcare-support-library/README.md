...
CommCare Support library also provides APIs for a biometric provider to integrate with CommCare. Read more: [identity integration guide](https://github.com/dimagi/commcare-android/blob/master/commcare-support-library/docs/identity_integration.md)
