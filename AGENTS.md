...
- In XML layouts, strictly use existing color, dimension, and style resources instead of hardcoded values; if no suitable resource exists, flag it rather than hardcoding one
