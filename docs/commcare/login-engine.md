...
The two remaining `ConnectAppUtils.launchApp` callers (`ConnectJobIntroFragment`, `ConnectDownloadingFragment`) still take the legacy `LoginActivity` path; `ConnectAppUtils.launchApp` itself is unchanged.
