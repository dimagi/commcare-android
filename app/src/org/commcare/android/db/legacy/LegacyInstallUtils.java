...
public class LegacyInstallUtils {
    ...
    public static void checkForLegacyInstall(Context c, SqlStorage<ApplicationRecord> currentAppStorage) throws StorageFullException, SessionUnavailableException {
        ...
        LegacySqlIndexedStorageUtility<Resource> legacyResources = new LegacySqlIndexedStorageUtility<Resource>(CommCareApp.GLOBAL_STORAGE_TABLE_KEY, ResourceModelUpdater.class, ldbh);
        ...
        SqlStorage<Resource> newInstallTable = app.getStorage(CommCareApp.GLOBAL_STORAGE_TABLE_KEY, Resource.class);
