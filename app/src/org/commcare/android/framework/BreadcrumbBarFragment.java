...
public class BreadcrumbBarFragment extends Fragment {
    ...
    private View findAndLoadCaseTile(final Activity activity) {
        ...
        final OnClickListener toggleButtonClickListener = new OnClickListener() {
     ...
     */
        ...
        private Pair<View, TreeReference> buildContextTile(final Activity activity, final Detail detail, final TreeReference ref, final AndroidSessionWrapper asw) {
            ...
            final GridEntityView tile = new GridEntityView(this.getActivity(), detail, entity, null);
            final int[] textColor = AndroidUtil.getThemeColorIDs(getActivity(), new int[]{R.attr.drawer_pulldown_text_color, R.attr.menu_tile_title_text_color});
