...
public class SigningUtil {
     ...
     */
    public static boolean verify(String publicKeyString, String message, String messageSignature) {
        try {
            PublicKey publicKey = getPublicKey(publicKeyString);
            boolean verified = verify(publicKey, message, messageSignature);
            return verified;
        } catch (Exception e) {
    ...
    private static boolean verify(PublicKey publicKey, String messageString, String signature) throws SignatureException {
        try {
