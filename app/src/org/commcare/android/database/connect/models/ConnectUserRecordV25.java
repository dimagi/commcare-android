...
@Table(ConnectUserRecordV25.STORAGE_KEY)
public class ConnectUserRecordV25 extends Persisted {
    ...
    public static ConnectUserRecordV25 fromV16(ConnectUserRecordV16 oldRecord, boolean hasConnectAccess) {
        ConnectUserRecordV25 newRecord = new ConnectUserRecordV25();
