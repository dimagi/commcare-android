...
public class CCAnalyticsEvent {
    ...
    static final String CCC_PAYMENT_INFO_VIEW = "ccc_payment_info_view";
    static final String CCC_PAYMENT_INFO_CHANGE_ATTEMPT = "ccc_payment_info_change_attempt";
    static final String CCC_PAYMENT_INFO_CHANGED = "ccc_payment_info_changed";
