...
public class FirebaseAnalyticsEvent {
    ...
    public static final String AUDIO_WIDGET_INTERACTION = "audio_widget_interaction";
    ...
    public static final String ENTER_PREF_ACTIVITY = "enter_a_preference_activity";
    ...
    public static final String OPEN_OPTIONS_MENU = "open_options_menu";
