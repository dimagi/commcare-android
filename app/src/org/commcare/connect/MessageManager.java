...
public class MessageManager {
            ...
            public void processSuccess(int responseCode, InputStream responseData) {
                try {
                    ...
                    if (responseAsString.length() > 0) {
                        ...
                        List<ConnectMessagingChannelRecord> existingChannels = ConnectMessageUtils.getMessagingChannels(context);
    ...
    public static void updateReceivedMessages(Context context, ConnectManager.ConnectActivityCompleteListener listener) {
        List<ConnectMessagingMessageRecord> messages = ConnectMessageUtils.getMessagingMessagesAll(context);
