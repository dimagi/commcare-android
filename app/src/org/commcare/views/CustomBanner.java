...
public class CustomBanner {
    ...
    public static boolean useCustomBanner(Context context,
        ...
        String customBannerURI =
                app.getAppPreferences().getString(HiddenCommCarePreferences.BRAND_BANNER_HOME, "");

        if (CommCareApplication.instance().isInDemoMode(false)) {
            customBannerURI =
                    app.getAppPreferences().getString(HiddenCommCarePreferences.BRAND_BANNER_HOME_DEMO,
                            customBannerURI);
        }
