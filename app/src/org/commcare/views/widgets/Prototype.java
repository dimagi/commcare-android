 ...
 * Prototype 1 of 3
 */
public class Prototype extends GregorianDateWidget implements CalendarFragment.CalendarCloseListener{
    ...
    public Prototype(Context con, FormEntryPrompt prompt){
        super(con, prompt, true, null);
