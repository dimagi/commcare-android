...
public class UpdateActivity extends CommCareActivity<UpdateActivity>
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        } else if (CommCareApplication.getInstance().isConsumerApp()) {
            proceedAutomatically = true;
            isLocalUpdate = true;
        }
    ...
    public void handleTaskCompletion(ResultAndError<AppInstallStatus> result) {
        ...
        if (result.data == AppInstallStatus.UpdateStaged) {
            ...
            if (UpdateTask.isCombinedErrorMessage(result.errorMessage)) {
                ...
                CommCareApplication.getInstance().reportNotificationMessage(NotificationMessageFactory.message(AppInstallStatus.InvalidResource, new String[]{null, resouceAndMessage.first, resouceAndMessage.second}), true);
            }
