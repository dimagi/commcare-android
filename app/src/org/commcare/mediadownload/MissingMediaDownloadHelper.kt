...
object MissingMediaDownloadHelper : TableStateListener {
     ...
     */
    @WorkerThread
    fun downloadAllLazyMedia(cancellationChecker: InstallCancelled): AppInstallStatus {
    ...
    private fun downloadResource(it: Resource): MissingMediaDownloadResult {
