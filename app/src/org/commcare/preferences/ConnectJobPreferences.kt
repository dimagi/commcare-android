...
class ConnectJobPreferences(
    ...
    fun updateTaskModifiedTime() {
        prefs.edit { putLong(KEY_TASK_LAST_MODIFIED_TIME, System.currentTimeMillis()) }
    }
    ...
    companion object {
        ...
        private const val KEY_TASK_LAST_MODIFIED_TIME = "task_last_modified_time"
