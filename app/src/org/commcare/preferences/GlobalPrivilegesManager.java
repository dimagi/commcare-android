...
public class GlobalPrivilegesManager {
    ...
    public static final String PRIVILEGE_ADVANCED_DEV_OPTIONS = "advanced_developer_options_access";
    ...
    /**
     * TODO: IMPORTANT -- Right now, the 'advanced_developer_options_access' flag doesn't actually
     * exist in any QR codes generated by HQ, so we're temporarily making this privilege picky-back
     * off of the multiple apps one. Once we've done the work necessary to add that flag, this
     * method should be updated accordingly.
     */
    public static boolean isAdvancedDeveloperOptionsAccessEnabled() {
        return isPrivilegeEnabled(PRIVILEGE_ADVANCED_DEV_OPTIONS) ||
