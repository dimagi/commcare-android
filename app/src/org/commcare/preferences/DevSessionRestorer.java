...
public class DevSessionRestorer {
    ...
    public static String getSerializedSessionString() {
        ...
        try {
            CommCareApplication.getInstance().getCurrentSession().serializeSessionState(serializedStream);
        } catch (IOException e) {
    ...
    public static void clearSession() {
        clearSession(CommCareApplication.getInstance().getCurrentApp().getAppPreferences());
    }
