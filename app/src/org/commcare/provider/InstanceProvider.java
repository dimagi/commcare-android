...
public class InstanceProvider extends ContentProvider {
    ...
    private void finalizeUnindexedInsertion(ContentValues values, Uri instanceUri) {
        ...
        SecretKey key;
        key = CommCareApplication.getInstance().createNewSymmetricKey();
    ...
    private FormRecord syncRecordToInstance(FormRecord record,
        ...
        try {
            return FormRecordCleanupTask.updateAndWriteRecord(CommCareApplication.getInstance(),
                    record, CommCareApplication.getInstance().getUserStorage(FormRecord.class));
