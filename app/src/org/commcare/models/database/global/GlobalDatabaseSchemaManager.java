...
public class GlobalDatabaseSchemaManager {
     ...
     */
    public static final int GLOBAL_DB_VERSION = 8;

    public static final String GLOBAL_DB_LOCATOR = "database_global";

    public static void initializeSchema(IDatabase database) {
