...
public class DatabaseGlobalOpenHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        DataChangeLogger.log("Starting upgrade for Global DB from " + oldVersion + " to " + newVersion);
        new GlobalDatabaseUpgrader(mContext).upgrade(db, oldVersion, newVersion);
        DataChangeLogger.log("Completed upgrade for Global DB from " + oldVersion + " to " + newVersion);
    }
