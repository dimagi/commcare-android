...
public class DatabaseUserOpenHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        try {
            if (CommCareApplication.getInstance().getCommCarePlatform() != null && CommCareApplication.getInstance().getCommCarePlatform().getCurrentProfile() != null) {
                if (CommCareApplication.getInstance().getCommCarePlatform().getCurrentProfile() != null &&
                        CommCareApplication.getInstance().getCommCarePlatform().getCurrentProfile().isFeatureActive("sense")) {
                    inSenseMode = true;
                }
            }
        } catch (Exception e) {
