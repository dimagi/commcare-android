...
public class EncryptedDatabaseAdapter implements IDatabase {
    SQLiteDatabase db;

    public EncryptedDatabaseAdapter(SQLiteDatabase db) {
        this.db = db;
    }

    public EncryptedDatabaseAdapter(SQLiteOpenHelper dbOpenHelper) {
