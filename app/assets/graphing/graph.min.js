...
var label=axis.xLabels[key]===undefined?d:axis.xLabels[key];var returnVal=String(Math.round(label)||label);if(returnVal.length>15){return String(returnVal).slice(0,12)+"...";}else{return returnVal;}};}
