...
import org.commcare.android.mocks.CommcareDiagnosticTaskMock;
...
@Config(application = CommCareTestApplication.class, sdk = 18, shadows = {CommcareDiagnosticTaskMock.class})
