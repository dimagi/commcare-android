...
public class DemoUserRestoreTest {
    ...
    private void checkOptionsMenuVisibility(ShadowActivity shadowHomeActivity) {
        ...
        assertTrue(shadowHomeActivity.getOptionsMenu().findItem(R.id.action_change_language).isVisible());
        assertFalse(shadowHomeActivity.getOptionsMenu().findItem(R.id.action_update).isVisible());
        assertFalse(shadowHomeActivity.getOptionsMenu().findItem(R.id.action_saved_forms).isVisible());
        assertFalse(shadowHomeActivity.getOptionsMenu().findItem(R.id.action_preferences).isVisible());
        assertFalse(shadowHomeActivity.getOptionsMenu().findItem(R.id.action_advanced).isVisible());
        assertFalse(shadowHomeActivity.getOptionsMenu().findItem(R.id.action_about).isVisible());
        assertFalse(shadowHomeActivity.getOptionsMenu().findItem(R.id.action_set_pin).isVisible());
    }
}
