...
public class AutoUpdateTest {
    ...
    public void testAutoUpdateCalc() {
        ...
        Assert.assertTrue(CommCareApplication.getInstance().isTimeForAutoUpdateCheck(checkedThreeDaysAgo,
        ...
        if (isSameDayAsNow(checkedThreeHoursAgo)) {
            Assert.assertFalse(CommCareApplication.getInstance().isTimeForAutoUpdateCheck(checkedThreeHoursAgo,
                    CommCarePreferences.FREQUENCY_DAILY));
        } else {
            Assert.assertTrue(CommCareApplication.getInstance().isTimeForAutoUpdateCheck(checkedThreeHoursAgo,
                    CommCarePreferences.FREQUENCY_DAILY));
        }
        ...
        Assert.assertTrue(CommCareApplication.getInstance().isTimeForAutoUpdateCheck(yesterdayNearMidnight.getMillis(),
                CommCarePreferences.FREQUENCY_DAILY));
        ...
        Assert.assertFalse(CommCareApplication.getInstance().isTimeForAutoUpdateCheck(hoursInTheFuture,
                CommCarePreferences.FREQUENCY_DAILY));
        ...
        Assert.assertTrue(CommCareApplication.getInstance().isTimeForAutoUpdateCheck(daysLater,
                CommCarePreferences.FREQUENCY_DAILY));

        long weekLater = DateTime.now().plusWeeks(1).getMillis();
        Assert.assertTrue(CommCareApplication.getInstance().isTimeForAutoUpdateCheck(weekLater,
                CommCarePreferences.FREQUENCY_DAILY));
    }
