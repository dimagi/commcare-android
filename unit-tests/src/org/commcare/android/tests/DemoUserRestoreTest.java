...
public class DemoUserRestoreTest {
    ...
    public void loginUsingDemoUserWithoutRestore() {
        ...
        CommCareApplication.getInstance().getCurrentApp().setMMResourcesValidated();
    ...
    public void demoUserRestoreAndUpdateTest() {
        ...
        assertEquals(1, CommCareApplication.getInstance().getCurrentApp().getStorage(UserKeyRecord.class).getNumRecords());
