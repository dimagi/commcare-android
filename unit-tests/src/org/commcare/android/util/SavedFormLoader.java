...
public class SavedFormLoader {
    ...
    public static void loadFormsFromPayload(String payloadFile, String recordStatus) {
        ...
        CommCarePlatform platform = CommCareApplication.getInstance().getCommCarePlatform();
        FormRecordCleanupTask<Object> task = new FormRecordCleanupTask<Object>(CommCareApplication.getInstance(), platform, -1, recordStatus) {
            @Override
